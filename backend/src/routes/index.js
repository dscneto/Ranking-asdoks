...
import * as coaches from '../controllers/coaches.js'
...
// ─── Professores ──────────────────────────────────────────────────────────────
router.get('/coaches', protect, coaches.getAll)
router.get('/coaches/ranking', protect, coaches.getRanking)
router.get('/coaches/:id', protect, coaches.getById)
router.post('/coaches', protect, coaches.create)
router.put('/coaches/:id', protect, coaches.update)
router.delete('/coaches/:id', protect, coaches.remove)
router.get('/coaches/:id/athletes', protect, coaches.getAthletes)
...
router.get('/athletes/:id/coaches', coaches.getAthleteCoaches)
router.put('/athletes/:id/coaches', protect, coaches.updateAthleteCoaches)
